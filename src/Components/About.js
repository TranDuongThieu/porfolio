    ...
    return (
        <div className={`w-full h-fit pb-20 flex flex-col justify-center items-center relative ${width === 3 ? "pt-40 " : "pt-20"} `}>
            <div className={`flex  ${width !== 3 ? "flex-col justify-center items-center gap-20" : "gap-10"}`}>
                ...
                <div className={`relative ${width === 3 ? " flex-none w-[40%]" : width === 2 ? "w-[95%]" : "w-[90%]"}`}>
                    <img src={about} className=" w-full h-full rounded-lg" alt="" />
                    <div className="absolute bottom-[-70px] right-[-50px]">
                        <div className={`relative flex items-center justify-center bg-white  rounded-full  ${width === 3 ? "w-[200px] h-[200px]" : "w-[150px] h-[150px]"} `}>
                            <img src={about3} alt="" className={`absolute  animate-spin-slow ${width === 3 ? "w-[220px]" : "w-[150px]"}`} />
